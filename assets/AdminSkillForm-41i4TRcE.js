import{c as e,f as t,o as n,s as r,t as i}from"./index-BR-L_-sg.js";import{I as a,t as o}from"./fa-BlK4pbMx.js";import{t as s}from"./supabase-DDu0klbY.js";import{n as c,t as l}from"./SkillIcon-CoJp1735.js";var u=t(e(),1),d=i();function f(){let e=n(),{id:t}=r(),i=!!t,[f,p]=(0,u.useState)(``),[m,h]=(0,u.useState)(``),[g,_]=(0,u.useState)(``),[v,y]=(0,u.useState)(i),[b,x]=(0,u.useState)(!1),[S,C]=(0,u.useState)(``),w=[`Frontend`,`Backend`,`Mobile`,`Database`,`Tools`,`Machine Learning`];(0,u.useEffect)(()=>{if(!i)return;async function e(){y(!0);let{data:e,error:n}=await s.from(`skills`).select(`
                    id,
                    name,
                    category,
                    icon
